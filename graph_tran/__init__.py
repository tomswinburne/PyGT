...
the original Markov chain into communities of microstates (nodes). Various
...
approach, which we call partial graph transformation, [3]_ select nodes that
...
All methods are discussed in detail in the following manuscript, which should
also be cited when using this software. [1]_

.. [1] D. Kannan, D. J. Sharpe, T. D. Swinburne, D. J. Wales, "Estimating reduced Markov chains from mean first passage times using graph transformation." *J. Chem. Phys.* (2020)

.. [3] D. Kannan, D. J. Sharpe, T. D. Swinburne, D. J. Wales, "Dimensionality reduction of complex networks with graph transformation" *Phys. Rev. E.* (2020)
